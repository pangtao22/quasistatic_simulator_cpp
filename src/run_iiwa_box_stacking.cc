...
const string kBox6cmPath = GetQsimModelsPath() / path("box_0.06m.sdf");
const string kBox7cmPath = GetQsimModelsPath() / path("box_0.07m.sdf");
const string kBox8cmPath = GetQsimModelsPath() / path("box_0.08m.sdf");
const string kModelDirectivePath =
    GetQsimModelsPath() / path("iiwa_and_schunk_and_ground.yml");
